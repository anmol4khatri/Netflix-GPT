...
{   method: 'GET',
    headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhYmQ5OGE1OTVlOTRkYTA5OTIxZTRiOWU3MDhlYjVlMSIsIm5iZiI6MTc0NzU3ODE1MS4yNTIsInN1YiI6IjY4MjllZDI3YzI2NGFlMzYyOTY0ODkzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.nzyqlp5NfJT-yt1v2aEJY1wQVQVRerUgrLSue49F8pI'
    }
};
