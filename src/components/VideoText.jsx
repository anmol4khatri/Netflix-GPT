        ...
        <div className="w-full aspect-video absolute z-10 text-white p-5 bg-gradient-to-r from-black">
            <div className="w-2/5 pt-[18%] pl-10">
                ...
                <div className="flex gap-6 mt-5 cursor-pointer">
                    <div className="h-12 flex bg-white text-black p-3 rounded-xl cursor-pointer hover:scale-125">
                    ...
                    <div className="h-12 flex bg-[#47484a] p-3 rounded-xl cursor-pointer hover:scale-125">
