const VideoText = ({title, overview}) => {
    return(
        <div className="w-md absolute top-100 left-15 z-10 text-white p-5">
            <h1 className="text-5xl mb-7">{title}</h1>
            <h3>{overview}</h3>
            <div className="flex gap-4 mt-5 cursor-pointer">
                <div className="h-12 flex bg-white text-black p-3 rounded-xl">
                    ...
                    <button className="w-13">Play</button>
                </div>
                <div className="h-12 flex bg-[#47484a] p-3 rounded-xl cursor-pointer">
                    ...
                    <button className="w-23">More Info</button>
                </div>
            </div>
        </div>
    );
